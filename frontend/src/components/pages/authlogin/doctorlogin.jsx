        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-teal-600 text-white p-8 lg:p-12 flex flex-col justify-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-blue-100 text-lg mb-8">
                Sign in to continue access as Doctor
              </p>
          ...
          <div className="p-8 lg:p-12">
            <h2 className="text-2xl font-bold text-slate-800 mb-6">
              {isSignup ? "Sign Up (Doctor)" : "Sign In (Doctor)"}
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105"
              >
